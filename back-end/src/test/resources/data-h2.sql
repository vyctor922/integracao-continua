...
INSERT INTO `atendimento` VALUES
    (1,'2022-06-01','14:00:00','AGENDADO',1,1,1),
    (2,'2022-06-01','14:00:00','AGENDADO',1,2,3),
    (3,'2022-06-01','14:30:00','AGENDADO',2,3,4),
    (4,'2022-06-01','15:00:00','AGENDADO',3,4,1),
    (5,'2022-06-01','15:00:00','AGENDADO',1,5,5);

INSERT INTO `convenio` VALUES
    (1,TRUE,'46.560.030/0001-53','contato@unimedriobranco.com.br','Unimed','Unimed Rio Branco Cooperativa de Trabalho Médico Ltda.','Thayline Figueredo Vaz','(68) 3668-1546'),
    (2,TRUE,'29.309.127/0001-79','contato@amil.com.br','Amil','AMIL ASSISTENCIA MEDICA INTERNACIONAL S.A.','Davi Faria da Conceição','(11) 3279-3035'),
    (3,TRUE,'92.693.118/0001-60','contato@bradescosaude.com.br','Bradesco','BRADESCO SAUDE S.A.','Leandra Paes dos Anjos','(21) 2503-0787');
...
INSERT INTO `usuario` VALUES
    (1,TRUE,'Administrador','admin','ROLE_ADMIN','$2a$10$zArhMpAXoIhDRvqmJSPI2uDJbGxoQft9g2LCa.7fBCOXDuqKVC6cS'),
    (2,TRUE,'Daniel','daniel','ROLE_ADMIN','$2a$10$ZKaOzSH3atFflX/Xs7.w2OqVwGiZNl/FhpPHyLt3AyI7YNaFmnFS2'),
    (3,TRUE,'Paulo','paulo','ROLE_ATENDENTE','$2a$10$5gqHW3bQnDx62QNLM6BzyespOh5A649KDB6mNw9UOJbo8eQCAqyG6');
